...
parser.add_argument("-s", action = "store", dest = "inputstring", help = "String to Be Proccessed",default="Hello Python")
parser.add_argument("-c", action = "store", dest = "configfile", help = "Configfile Containing Instructions",default="config.yaml")
